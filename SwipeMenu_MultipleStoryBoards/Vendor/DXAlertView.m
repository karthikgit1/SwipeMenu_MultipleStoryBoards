   ...
   rightButtonTitle:(NSString *)rigthTitle
{
    if (self = [super init])
    {
        NSLog(@"kTitleYOffset is %f",kTitleYOffset);
        self.layer.cornerRadius = 2.0;
        self.backgroundColor = [UIColor whiteColor];
        self.alertTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(40, kTitleYOffset + 10, kAlertWidth, kTitleHeight)];
...
//#define kCoupleButtonWidth 107.0f
        #define kCoupleButtonWidth 30.0f
...
//        [self.rightBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        ...
        [self.leftBtn setImage:[UIImage imageNamed:@"btn_close_selected.png"] forState:UIControlStateNormal];
        
        [self.rightBtn setImage:[UIImage imageNamed:@"btn_close_normal.png"] forState:UIControlStateNormal];
